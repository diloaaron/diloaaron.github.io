...
self-contained: true  
---
[Click here to download/view the Full Thesis (PDF)](documents/analysis.pdf)
...
mfx <- slopes(
  ...
  vcov = "HC1"   # match your robust SE specification
)
...
ggsave(
  filename = "figures/quality_vs_quantity.pdf",
