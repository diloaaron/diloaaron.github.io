...
This script transforms individual raw data sets from the OECD’s Quality Indicator, Cohort, and HAN/HARM databases into analysis-ready patent quality indicators, following the OECD paper’s methodology. The pipeline applies normalization/winsorization procedures, and produces both patent-level and country-year aggregated datasets suitable for econometric analysis of innovation quality. Source: Squicciarini, M., Dernis, H., & Criscuolo, C. (2013). Measuring Patent Quality: Indicators of Technological and Economic Value. OECD Science, Technology and Industry Working Papers, 2013/03.
...
*going to add a more substantial description here, include sources for the data*
...
*description will go here as well*
...
`researchers_per_million_x` researchers per million, used to scale patent counts `population_total` alternative scaling variable

`bank_credit_gdp` Ratio of bank credit to GDP, represents size of banking sector `market_cap_gdp` Market Cap of domestically listed companies, represents depth of stock market
