...
```{r eval = TRUE, echo = TRUE}
# ============================================================
# COLLINEARITY & VALIDITY DIAGNOSTICS
# ============================================================
...
# ------------------------------------------------------------
# 1. CORRELATION MATRICES (KEY CHECK)
# ------------------------------------------------------------

cat("============================================\n")
cat("PAIRWISE CORRELATIONS (LEVELS)\n")
cat("============================================\n\n")
...
# ------------------------------------------------------------
# 2. VIFs — POOLED ANALOGUE MODELS
# (Diagnostic only; FE VIFs not well-defined)
# ------------------------------------------------------------

cat("============================================\n")
cat("VIF DIAGNOSTICS (POOLED MODELS)\n")
cat("============================================\n\n")
...
# VC-based analogue (restricted sample)
lm_vc <- lm(
  quality_index_100 ~ ln_vc + ipr_c + ln_vc_x_ipr +
    ln_gdp_pc + ln_trade + ln_rd + ln_tertiary +
    factor(iso3c) + factor(year),
